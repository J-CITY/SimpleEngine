...
InputManager::InputManager(IKIGAI::WINDOW_SYSTEM::Window& _window) : window(_window) {
...
IKIGAI::MATHGL::Vector2i InputManager::getMousePosition() const {
...
IKIGAI::INPUT::Gamepad::GamepadData InputManager::getGamepad(int id) {
