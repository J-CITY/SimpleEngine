...
namespace IKIGAI::INPUT_SYSTEM {
	...
	public:
		...
		[[nodiscard]] IKIGAI::INPUT::Gamepad::GamepadData getGamepad(int id);
	...
	private:
		...
		void onGamepad(IKIGAI::INPUT::Gamepad::GamepadData gd);
		...
		std::unordered_map<int, IKIGAI::INPUT::Gamepad::GamepadData> gamepads;
	};
}
