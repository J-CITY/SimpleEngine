...
bool IKIGAI::MATHGL::operator==(const Vector3& left, const Vector3& right) {
...
Vector3 IKIGAI::MATHGL::operator*(const float f, const Vector3& V) {
	return V * f;
}
...
RTTR_REGISTRATION
{
	rttr::registration::class_<IKIGAI::MATHGL::Vector3>("Vector3")
	.property("X", &IKIGAI::MATHGL::Vector3::x)
	.property("Y", &IKIGAI::MATHGL::Vector3::y)
	.property("Z", &IKIGAI::MATHGL::Vector3::z);
}
