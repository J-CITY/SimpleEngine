...
Quaternion IKIGAI::MATHGL::operator*(const float f, const Quaternion& V) {
	return V * f;
}
...
RTTR_REGISTRATION
{
	rttr::registration::class_<IKIGAI::MATHGL::Quaternion>("Quaternion")
	.property("X", &IKIGAI::MATHGL::Quaternion::x)
	.property("Y", &IKIGAI::MATHGL::Quaternion::y)
	.property("Z", &IKIGAI::MATHGL::Quaternion::z)
	.property("W", &IKIGAI::MATHGL::Quaternion::w);
}
