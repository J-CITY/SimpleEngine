...
namespace IKIGAI::UTILS {
	...
	std::string ReplaceSubstring(const std::string& _subject, const std::string& search, const std::string& replace);
	...
	bool IsFindInString(const std::string& s, const std::string& subs);
}
