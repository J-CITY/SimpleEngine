...
void main() {
    ...
    vs_out.FragPosDirLightSpace = engine_ShadowUBO.dirLightSpaceMatrix * vec4(vs_out.FragPos, 1.0);
    vs_out.FragPosSpotLightSpace = engine_ShadowUBO.spotLightSpaceMatrix * vec4(vs_out.FragPos, 1.0);
