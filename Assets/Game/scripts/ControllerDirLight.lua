...
function Controller:HandleMovement(deltaTime)
    ...
    if Inputs.GetKeyDown(Key.H) then velocity = velocity + right end
    if Inputs.GetKeyDown(Key.L) then velocity = velocity - right end
    if Inputs.GetKeyDown(Key.J) then velocity = velocity + forward end
    if Inputs.GetKeyDown(Key.K) then velocity = velocity - forward end
    pos = pos + velocity
