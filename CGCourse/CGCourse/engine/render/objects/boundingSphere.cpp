...
float KUMA::RENDER::BoundingSphere::calcGrowth(const BoundingSphere& sphere) const {
...
float KUMA::RENDER::BoundingSphere::getSize() const {
	return 1.33333f * 3.1415 * radius * radius * radius; /* ( ( 4 / 3 ) * pi * r^3 ) */
}

int KUMA::RENDER::BoundingSphere::intersect(const BoundingSphere& sphere) const {
...
void KUMA::RENDER::BoundingSphere::createFromTwo(const BoundingSphere& one, const BoundingSphere& two) {
