...
std::shared_ptr<KUMA::RENDER::TextureVk> TextureVk::createDepthForAttach(unsigned int texWidth, unsigned int texHeight) {
...
std::shared_ptr<TextureVk> TextureVk::createCubemap(std::array<std::string, 6> path) {
	...
	textureData[0] = KUMA::RESOURCES::stbiLoad(path[0].c_str(), &width, &height, &numberOfChannels, 4);
	textureData[1] = KUMA::RESOURCES::stbiLoad(path[1].c_str(), &width, &height, &numberOfChannels, 4);
	textureData[2] = KUMA::RESOURCES::stbiLoad(path[2].c_str(), &width, &height, &numberOfChannels, 4);
	textureData[3] = KUMA::RESOURCES::stbiLoad(path[3].c_str(), &width, &height, &numberOfChannels, 4);
	textureData[4] = KUMA::RESOURCES::stbiLoad(path[4].c_str(), &width, &height, &numberOfChannels, 4);
	textureData[5] = KUMA::RESOURCES::stbiLoad(path[5].c_str(), &width, &height, &numberOfChannels, 4);
	...
	KUMA::RESOURCES::stbiImageFree(textureData[0]);
	KUMA::RESOURCES::stbiImageFree(textureData[1]);
	KUMA::RESOURCES::stbiImageFree(textureData[2]);
	KUMA::RESOURCES::stbiImageFree(textureData[3]);
	KUMA::RESOURCES::stbiImageFree(textureData[4]);
	KUMA::RESOURCES::stbiImageFree(textureData[5]);
...
std::shared_ptr<TextureVk> TextureVk::create(std::string path) {
	...
	int nChannels;
	unsigned char* image = KUMA::RESOURCES::stbiLoad(texture->path.c_str(), &texture->width, &texture->height, &nChannels, 4);
	...
	KUMA::RESOURCES::stbiImageFree(image);
