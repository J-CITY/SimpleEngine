...
using namespace KUMA::ANIMATION;

import glmath;

float animation::linearInterpolation(float a)
{
	return a;
}

float animation::quadraticEaseIn(float a)
{
	return a * a;
}

float animation::quadraticEaseOut(float a)
{
	return -(a * (a - static_cast<float>(2)));
}

float animation::quadraticEaseInOut(float a)
{
...
float animation::cubicEaseIn(float a)
{
	return a * a * a;
}

float animation::cubicEaseOut(float a)
{
	float const f = a - 1.0f;
	return f * f * f + 1.0f;
}

float animation::cubicEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
	{
...
float animation::quarticEaseIn(float a)
{
	return a * a * a * a;
}

float animation::quarticEaseOut(float a)
{
	float const f = (a - 1.0f);
	return f * f * f * (1.0f - a) + 1.0f;
}

float animation::quarticEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
	{
...
float animation::quinticEaseIn(float a)
{
	return a * a * a * a * a;
}

float animation::quinticEaseOut(float a)
{
	float const f = (a - 1.0f);
	return f * f * f * f * f + 1.0f;
}

float animation::quinticEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
	{
...
float animation::sineEaseIn(float a)
{
	return sin((a - 1.0f) * (PI / 2.0f)) + 1.0f;
}

float animation::sineEaseOut(float a)
{
	return sin(a * (PI / 2.0f));
}

float animation::sineEaseInOut(float a)
{
	return static_cast<float>(0.5) * (1.0f - cos(a * PI));
}

float animation::circularEaseIn(float a)
{
	return 1.0f - sqrt(1.0f - (a * a));
}

float animation::circularEaseOut(float a)
{
	return sqrt((static_cast<float>(2) - a) * a);
}

float animation::circularEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
	{
...
float animation::exponentialEaseIn(float a)
{
	if (a <= 0.0f)
		return a;
	else
...
float animation::exponentialEaseOut(float a)
{
	if (a >= 1.0f)
		return a;
	else
...
float animation::exponentialEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
...
float animation::backEaseInInternal(float a, float o)
{
	float z = ((o + 1.0f) * a) - o;
	return (a * a * z);
}

float animation::backEaseOutInternal(float a, float o)
{
	float n = a - 1.0f;
	float z = ((o + 1.0f) * n) + o;
	return (n * n * z) + 1.0f;
...
float animation::backEaseInOutInternal(float a, float o)
{
...
float animation::backEaseIn(float a)
{
	return backEaseInInternal(a, static_cast<float>(1.70158));
}

float animation::backEaseOut(float a)
{
	return animation::backEaseOutInternal(a, static_cast<float>(1.70158));
}

float animation::backEaseInOut(float a)
{
	return animation::backEaseInOutInternal(a, static_cast<float>(1.70158));
}

float animation::bounceEaseOut(float a)
{
...
float animation::bounceEaseIn(float a)
{
	return 1.0f - bounceEaseOut(1.0f - a);
}

float animation::bounceEaseInOut(float a)
{
	if (a < static_cast<float>(0.5))
	{
